...
var ToolMessageChunk = class _ToolMessageChunk extends BaseMessageChunk {
  ...
  concat(chunk) {
    return new _ToolMessageChunk({
      content: mergeContent(this.content, chunk.content),
      additional_kwargs: _ToolMessageChunk._mergeAdditionalKwargs(this.additional_kwargs, chunk.additional_kwargs),
...
var Runnable = class extends Serializable {
  ...
  async _callWithConfig(func, input, options) {
    ...
    const runManager = await (callbackManager_ == null ? void 0 : callbackManager_.handleChainStart(this.toJSON(), _coerceToDict2(input, "input"), void 0, config == null ? void 0 : config.runType, void 0, void 0, (config == null ? void 0 : config.runName) ?? this.getName()));
    let output;
    try {
  ...
  async _batchWithConfig(func, inputs, options, batchOptions) {
    ...
    const runManagers = await Promise.all(callbackManagers.map((callbackManager, i) => callbackManager == null ? void 0 : callbackManager.handleChainStart(this.toJSON(), _coerceToDict2(inputs[i], "input"), void 0, optionsList[i].runType, void 0, void 0, optionsList[i].runName ?? this.getName())));
    let outputs;
    try {
  ...
  async *_transformStreamWithConfig(inputGenerator, transformer, options) {
    ...
    let runManager;
    try {
      const pipe = await pipeGeneratorWithSetup(transformer.bind(this), wrapInputForTracing(), async () => callbackManager_ == null ? void 0 : callbackManager_.handleChainStart(this.toJSON(), { input: "" }, void 0, config == null ? void 0 : config.runType, void 0, void 0, (config == null ? void 0 : config.runName) ?? this.getName()), config);
...
@langchain/core/dist/utils/fast-json-patch/src/duplex.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-GZ52E5XK.js.map
