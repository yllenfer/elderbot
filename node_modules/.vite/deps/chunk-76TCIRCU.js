...
var BaseLLMOutputParser = class extends Runnable {
  ...
  async invoke(input, options) {
    if (typeof input === "string") {
      ...
      return this._callWithConfig(async (input2) => this.parseResult([
        {
          message: input2,
          text: typeof input2.content === "string" ? input2.content : JSON.stringify(input2.content)
        }
...
*/
//# sourceMappingURL=chunk-76TCIRCU.js.map
